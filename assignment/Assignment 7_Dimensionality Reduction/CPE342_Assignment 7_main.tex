...
% =========================================================================
\begin{center}
    {\Large \textbf{รายงานวิชาการฉบับสมบูรณ์ (Comprehensive Academic Report)}}\\[0.3em]
    {\LARGE \textbf{การลดมิติข้อมูลด้วยการวิเคราะห์องค์ประกอบหลัก}}\\[0.2em]
    {\Large \textbf{(Dimensionality Reduction via Principal Component Analysis)}}\\[0.4em]
    {\normalsize วิชา CPE 342 Machine Learning — ภาคการศึกษาที่ 1 ปีการศึกษา 2567 / 2569}\\[0.2em]
    {\normalsize ภาควิชาวิศวกรรมคอมพิวเตอร์ คณะวิศวกรรมศาสตร์ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี}
\end{center}
...
\vspace{0.3em}
\noindent\textbf{ผู้จัดทำ (Group Members):}
\begin{enumerate}[leftmargin=1.8em, itemsep=0pt]
    \item \raggedright \textbf{นายวิศิษฐ์ สุวรรณเนาว์ (Wisit Suwannao)} — รหัสนักศึกษา: \codevar{67070501042}
    \item \raggedright \textbf{นายนัธทวัฒน์ ปริมสิริคุณาวุฒิ (Natthawat Primsirikunawut)} — รหัสนักศึกษา: \codevar{67070501027}
\end{enumerate}
\noindent\textbf{อาจารย์ผู้สอน (Instructor):} ดร. บุณยฤทธิ์ ช่างไชยวัล (Dr. Boonyarit Changaival)\\[0.2em]
\noindent\textbf{ไฟล์ส่งงานหลัก (Submission Artifacts):} \codevar{67\_1027\_1042.ipynb} (รันครบ $17$ Code Cells), \codevar{CPE342\_Assignment 7\_main.pdf}
...
% SECTION 1
% =========================================================================
\section{บทนำและรากฐานทางคณิตศาสตร์ของการลดมิติข้อมูล}
...
\subsection{การจัดกึ่งกลางข้อมูลและการสร้างเมทริกซ์ความแปรปรวนร่วม}
...
\subsection{การแยกสเปกตรัมและการฉายภาพเชิงตั้งฉาก}
...
\subsection{สัดส่วนความแปรปรวนที่อธิบายได้ (PVE)}
...
% SECTION 2
% =========================================================================
\section{การคำนวณและตรวจสอบ Linear PCA แบบทีละขั้นตอน (Part I)}
...
\subsection{ผลการคำนวณเชิงตัวเลขที่ตรวจสอบความถูกต้อง 100\%}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\linewidth]{plot_1_linear_pca_geometry.pdf}
\caption{การแจกแจงของข้อมูล 12 จุดและแกนองค์ประกอบหลัก $p_1, p_2$ ที่มีจุดกำเนิด ณ จุดเฉลี่ย $\boldsymbol{\mu}$}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.82\linewidth]{plot_2_projection_reconstruction.pdf}
...
% SECTION 3
% =========================================================================
\section{การสำรวจและสถาปัตยกรรมชุดข้อมูล MTCARS (Part II)}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{plot_3_mtcars_eda_corrmat.pdf}
...
% SECTION 4
% =========================================================================
\section{การเปรียบเทียบเชิงวิเคราะห์ระหว่าง Unstandardized และ Standardized PCA}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{plot_4_scree_pve_comparison.pdf}
\caption{การเปรียบเทียบ Scree Plot และความแปรปรวนสะสมระหว่างสองระเบียบวิธี}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{plot_5_pc_loadings_barplot.pdf}
...
% =========================================================================
\clearpage
\section*{5. คำตอบคำถามเชิงลึกประจำการทดลอง (Questions and Answers)}
\vspace{-0.8em}
\subsection*{คำถามที่ 2.1: การวิเคราะห์ PCA บนข้อมูลไม่ปรับมาตรฐาน (Question 2.1)}
\vspace{-0.5em}

\begin{tcolorbox}[fontupper=\small, colback=gray!3!white, colframe=gray!45!black, left=6pt, right=6pt, top=3pt, bottom=3pt, boxrule=0.5pt, arc=2pt, boxsep=1pt]
...
\textbf{คำตอบ:} ใช้เพียง \textbf{1 PC (PC1 เพียงแกนเดียว)} ก็เพียงพออย่างสมบูรณ์\\[0.05em]
...
\textbf{คำตอบ:} ตัวแปรที่ได้รับค่าน้ำหนักสูงอย่างมีนัยสำคัญคือ \textbf{\codevar{disp} (Displacement)} และ \textbf{\codevar{hp} (Horsepower)}\\[0.05em]
...
% =========================================================================
\clearpage
\subsection*{คำถามที่ 2.2: การวิเคราะห์ PCA แบบปรับมาตรฐานและเปรียบเทียบเชิงลึก (Question 2.2)}
\vspace{-0.5em}
...
\noindent\textbf{\normalsize (a) จำนวน PCs ที่เพียงพอสำหรับอธิบายความแปรปรวนรวม $\ge 90\%$}\par\vspace{0.05em}
\textbf{คำตอบ:} ต้องใช้ \textbf{4 PCs} เพื่อให้ครอบคลุมเกิน $90\%$ อย่างสมบูรณ์ ($\mathbf{92.32\%}$) หรืออนุโลมให้เป็น \textbf{3 PCs} หากยอมรับค่าประมาณใกล้เคียง ($\mathbf{89.87\% \approx 90\%}$)
\begin{itemize}[leftmargin=1.3em, itemsep=0.5pt, topsep=0.5pt]
...
\vspace{-0.1em}
\noindent\textbf{\normalsize (b) ตัวแปรตั้งต้นที่ได้รับค่าน้ำหนัก (Loadings) สูงในแกน PC1}\par\vspace{0.05em}
\textbf{คำตอบ:} ใน Standardized PCA \textbf{ทุกตัวแปรมีบทบาทร่วมกันอย่างสมดุล} ($|w_j| \in [0.20, 0.37]$) โดยแบ่งขั้วการกระจายตัวออกเป็น 2 กลุ่มตรงข้ามอย่างชัดเจน:
\begin{enumerate}[leftmargin=1.3em, itemsep=0.5pt, topsep=0.5pt]
...
\textbf{คำตอบ:} แตกต่างกันอย่างมหาศาลและมีความสำคัญเชิงรากฐานทางสถิติ (Dramatically Different) ด้วยเหตุผล 3 ประการ:
\begin{enumerate}[leftmargin=1.3em, itemsep=0.5pt, topsep=0.5pt]
...
% =========================================================================
\clearpage
\section{การตีความทางเรขาคณิตและการวิเคราะห์ 2D Biplot}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\linewidth]{plot_6_pca_biplot_2d.pdf}
\caption{แผนภาพ 2D PCA Biplot บนชุดข้อมูล MTCARS ที่ผ่านการปรับมาตรฐาน (Standardized)}
\end{figure}

\subsection{การวิเคราะห์กลุ่มยานยนต์เชิงความหมาย (Semantic Vehicle Clustering)}
...
\subsection{การตรวจสอบข้อผิดพลาดในการฟื้นฟูข้อมูล (Reconstruction Error Curve)}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\linewidth]{plot_7_reconstruction_error.pdf}
...
% SECTION 7
% =========================================================================
\section{บทสรุปและแนวปฏิบัติที่ดีที่สุดในงานวิศวกรรมข้อมูล}
...
รายละเอียดต่อไปนี้คือโค้ด Python ที่ใช้แก้ปัญหาและวิเคราะห์แบบจำลอง Dimensionality Reduction via PCA บนชุดข้อมูล MTCARS พร้อมผลลัพธ์และกราฟทั้งหมด ซึ่งได้รันจริงจาก Jupyter Notebook (\texttt{[Lab] Dimensionality Reduction.ipynb} หรือ \texttt{67\_1027\_1042.ipynb})

\input{notebook_appendix_7.tex}
