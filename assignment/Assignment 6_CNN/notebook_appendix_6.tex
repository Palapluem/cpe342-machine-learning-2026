...
# Publication-grade architecture and tensor pipeline visualization
fig = plt.figure(figsize=(16, 11), dpi=300)
gs = fig.add_gridspec(2, 2, height_ratios=[1.15, 0.95], width_ratios=[1.25, 1.0], hspace=0.28, wspace=0.18)

# Panel (a): End-to-End Pipeline with 3D Tensor Transformations
ax_top = fig.add_subplot(gs[0, :])
ax_top.text(0.1, 5.30, 'Panel (a): End-to-End Transfer Learning & Tensor Dataflow Pipeline (MobileNetV2 Backbone)',
            fontsize=12, fontweight='bold', color='#0F172A')

# Panel (b): MobileNetV2 Inverted Residual Block Micro-Architecture
ax_bl = fig.add_subplot(gs[1, 0])
ax_bl.text(0.2, 7.30, 'Panel (b): MobileNetV2 Inverted Residual Block with Linear Bottleneck',
           fontsize=10.5, fontweight='bold', color='#0F172A')

# Panel (c): Architectural Efficiency & Complexity Synthesis Benchmark
ax_br = fig.add_subplot(gs[1, 1])
ax_br.text(0.2, 7.30, 'Panel (c): Architectural Efficiency & Complexity Synthesis',
           fontsize=10.5, fontweight='bold', color='#0F172A')
