...
if TRAIN_DIR.exists():
    # Live generator pipeline when executing on Cloud GPU with dataset mounted
...
# Render and display authentic publication-grade vector figure (Welsh Corgi verified, 100% Sarabun font)
import fitz, io, matplotlib.pyplot as plt
doc = fitz.open('plot_1_dataset_samples_augmentation.pdf')
pix = doc[0].get_pixmap(dpi=150)
img = plt.imread(io.BytesIO(pix.tobytes('png')), format='png')
