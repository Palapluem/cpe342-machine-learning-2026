...
val_gen.reset(); val_prob = model.predict(val_gen, verbose=1).ravel(); val_pred = (val_prob >= 0.5).astype(int); val_true = val_gen.classes; val_cm = confusion_matrix(val_true, val_pred)
\end{lstlisting}
\needspace{3\baselineskip}
...
plt.subplots_adjust(top=0.92, bottom=0.04, hspace=0.35, wspace=0.15); plt.savefig('plot_8_test_predictions_error_analysis.pdf', bbox_inches='tight'); plt.show()
\end{lstlisting}
\needspace{3\baselineskip}
