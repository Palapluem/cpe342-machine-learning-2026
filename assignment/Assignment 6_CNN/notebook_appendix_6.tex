...
Execution note    : full experiment executed on the Cloud GPU environment\end{lstlisting}
...
NumPy Version     : 2.4.1
GPU Available     : [PhysicalDevice(name='/physical_device:GPU:0', device_type='GPU')]\end{lstlisting}
...
Class mapping: {'cat': 0, 'dog': 1}\end{lstlisting}
...
\begin{lstlisting}[style=output]
<Figure size at plot_1_dataset_samples_augmentation>\end{lstlisting}
\begin{figure}[H]
\centering
...
Result: FAIL — below the required 90–95% precision threshold\end{lstlisting}
...
Non-trainable params: 2,257,984 (8.61 MB)\end{lstlisting}
...
\begin{lstlisting}[style=output]
<Figure 2: architecture comparison>\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}[style=output]
Callbacks configured: EarlyStopping (patience=3) and ReduceLROnPlateau (factor=0.3)\end{lstlisting}
...
Epoch 8: early stopping\end{lstlisting}
...
Epoch 10/10
563/563 - 851s - 2s/step - accuracy: 0.9761 - loss: 0.1403 - val_accuracy: 0.9747 - val_loss: 0.1448 - learning_rate: 1.0000e-05\end{lstlisting}
...
<Figure size at plot_3_training_history_twophase>\end{lstlisting}
\begin{figure}[H]
\centering
...
Validation diagnostics retained separately for Figures 4 and 8 (N=4500)\end{lstlisting}
...
\begin{lstlisting}[style=output]
<Figure size at plot_4_confusion_matrix_roc_pr>\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}[style=output]
{'block_1_expand_relu': (1, 80, 80, 96), 'block_13_expand_relu': (1, 10, 10, 576), 'out_relu': (1, 5, 5, 1280)}\end{lstlisting}
...
\begin{lstlisting}[style=output]
<Figure size at plot_5_feature_map_activations>\end{lstlisting}
\begin{figure}[H]
\centering
...
INT8 is not included: no implemented/evaluated INT8 artifact is available.\end{lstlisting}
...
\begin{lstlisting}[style=output]
<Figure size at plot_6_ablation_augmentation_finetuning>\end{lstlisting}
\begin{figure}[H]
\centering
...
Interpretation: a human face is outside the Cat/Dog training distribution; the sigmoid must still choose one class.\end{lstlisting}
...
No webcam capture, AR rendering, or end-to-end 30-FPS guarantee is claimed.\end{lstlisting}
...
\begin{lstlisting}[style=output]
<Figure size at plot_7_inference_streaming_pipeline>\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}[style=output]
<Figure size at plot_8_test_predictions_error_analysis>\end{lstlisting}
\begin{figure}[H]
\centering
\vspace{-0.6em}
...
**M3 MobileNetV2 — top 40 layers fine-tuned with training-only augmentation.** Cat=0, Dog=1; input `160×160×3`; rescale `1./255`; seed 42.\end{lstlisting}
