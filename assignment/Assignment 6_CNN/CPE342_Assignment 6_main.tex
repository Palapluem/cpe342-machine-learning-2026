...
\begin{itemize}[leftmargin=1.8em, itemsep=0.5pt, topsep=1pt, parsep=0pt]
    ...
    \item \textbf{Post-Training Quantization (INT8):} เมื่อประยุกต์ทำ Quantization เพื่อลดทอนค่าน้ำหนักจาก Float32 เป็น Int8 จะช่วยลดขนาดไฟล์โมเดลลงได้สูงสุด $\approx 70\%$ และเพิ่มประสิทธิภาพการประมวลผลบนหน่วยประมวลผล NPU ของสมาร์ตโฟน (เช่น Apple Neural Engine หรือ Snapdragon NPU) สำหรับการทำงาน On-Device อย่างมีประสิทธิภาพ
\end{itemize}
