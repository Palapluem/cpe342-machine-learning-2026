...
\subsection*{4.3 การวิเคราะห์ตัวอย่างการทำนายเชิงประจักษ์และโครงสร้างความผิดพลาด\\ \normalsize(Qualitative Empirical Evaluation \& Failure Topology Analysis)}
...
\subsection*{4.6 การจำลองระบบตรวจจับแบบสตรีมมิ่งวิดีโอและฟิลเตอร์ภาพสด\\ \normalsize(Real-Time Streaming Video Pipeline \& AR Filter Simulation)}
