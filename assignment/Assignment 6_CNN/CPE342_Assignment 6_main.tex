...
\begin{itemize}[leftmargin=1.8em, itemsep=1pt]
    ...
    \item \textbf{ส่วนเผื่อเวลาด้านความปลอดภัย (Safety Margin):} มี Headroom สูงถึง \textbf{8.33 ms (25.0\%)} ต่ำกว่าเพดาน 33.33 ms ยืนยันความเป็นไปได้ในเชิงสถาปัตยกรรม (Architectural Feasibility) ที่จะรองรับการแสดงผล 30 FPS อย่างลื่นไหลในระบบจำลองสตรีมมิ่ง
\end{itemize}
...
\begin{enumerate}[leftmargin=14pt, itemsep=1.5pt, topsep=1pt, parsep=0pt]
    ...
    \begin{itemize}[leftmargin=10pt, itemsep=0.5pt, topsep=0.5pt, parsep=0pt]
        ...
        \item \textbf{2. Normalization \& Tensor Formatting}: ปรับสเกลช่วงพิกเซลเป็น $[0, 1]$ บน GPU ใช้เวลา \textbf{1.1 ms}
    ...
    ระบบจำลองมีส่วนเผื่อเวลาด้านความปลอดภัย (Safety Margin) สูงถึง \textbf{8.33 ms (25.0\%)} ต่ำกว่าเพดาน 33.33 ms ยืนยันความเป็นไปได้ในเชิงสถาปัตยกรรม (Architectural Feasibility) ในการรองรับ 30 FPS ได้อย่างลื่นไหล
