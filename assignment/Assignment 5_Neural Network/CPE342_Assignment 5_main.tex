...
\begin{figure}[H]
    ...
    \caption{\textbf{Diagnostic Confusion Matrix (Baseline Model Test Set, $N=10,000$)}: เมทริกซ์ความสับสนแสดงความถี่ในการจำแนกตัวเลขทั้ง 10 คลาส พร้อมระบุคู่สับสนที่เกิดขึ้นบ่อยที่สุด เช่น ตัวเลข 7 สับสนเป็น 9 (34 ตัวอย่าง) และตัวเลข 4 สับสนเป็น 9 (22 ตัวอย่าง)}
\end{figure}
