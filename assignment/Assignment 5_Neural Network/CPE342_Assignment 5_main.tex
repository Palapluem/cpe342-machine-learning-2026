...
\clearpage
\appendix
\section*{ภาคผนวก: โค้ดและบันทึกการทำงานของ Jupyter Notebook\\ \large(Appendix: Full Jupyter Notebook Code \& Output)}

รายละเอียดต่อไปนี้คือโค้ด Python ที่ใช้แก้ปัญหาและวิเคราะห์แบบจำลอง Deep Neural Network บนชุดข้อมูล MNIST พร้อมผลลัพธ์และกราฟทั้งหมด ซึ่งได้รันจริงจาก Jupyter Notebook (\texttt{Assignment\_5\_Deep\_Neural\_Network.ipynb} / \texttt{1027\_1042.ipynb})
