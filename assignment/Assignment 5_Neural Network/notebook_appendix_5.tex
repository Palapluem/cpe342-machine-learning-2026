...
\textbf{1. Learn About the Data}\par\smallskip
\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{2. Build Neural Network Model}\par\smallskip
\smallskip
...
> INPUT -> LINEAR -> RELU -> LINEAR -> SOFTMAX\par
\smallskip
...
\texttt{}`\par
optimizer='sgd',\par
loss='categorical\_crossentropy',\par
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{3. Preprocessing}\par\smallskip
\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{4. Model Training}\par\smallskip
\smallskip
...
Epoch 09: Train Loss=0.2960, Val Loss=0.2379 (Gap=-0.0581) | Train Acc=0.9187, Val Acc=0.9357 (Gap=+0.0170)
Epoch 10: Train Loss=0.2861, Val Loss=0.2310 (Gap=-0.0551) | Train Acc=0.9212, Val Acc=0.9358 (Gap=+0.0146)
\end{lstlisting}
\needspace{4\baselineskip}
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{5. Model Evaluation}\par\smallskip
\smallskip
...
Classification Report:
           ...
           6     0.9260    0.9541    0.9398       958
           7     0.9438    0.9154    0.9294      1028
           8     0.8914    0.8932    0.8923       974
           9     0.9022    0.9049    0.9035      1009
    accuracy                         0.9262     10000
   macro avg     0.9256    0.9252    0.9252     10000
...
\smallskip
\textbf{1. Frequently Misclassified Classes:}\par\smallskip
...
\smallskip
\textbf{2. Precision and Recall of the Model:}\par\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{6. Model tuning}\par\smallskip
\smallskip
Try tuning your model by:\par
1. Adjust the learning rate of your optimizer by increasing and decreasing the learning rate to see how it affects your model.\par
2. Experiment with different optimizers ('sgd', 'rmspop', 'adagrad', 'adam', See https://keras.io/optimizers ) to see which one converges faster.\par
3. Change the structure of your model by adding more hidden layers with any number of nodes, and then observe how this affects your model.\par
\smallskip
\end{tcolorbox}
\needspace{3\baselineskip}
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{7. Discussion and Result}\par\smallskip
...
\smallskip
\textbf{1. Learning Rate ($\alpha$) Adjustment:}\par\smallskip
...
\smallskip
\textbf{2. Optimizer Comparison:}\par\smallskip
...
\smallskip
\textbf{3. Changing Model Structure (Depth \& Dropout):}\par\smallskip
\textbullet\ \textbf{Deeper Multi-Layer Architecture (512 $	o$ 256 $	o$ 128)}: Adding more non-linear layers enables the network to extract hierarchical abstractions of digits (edges $	o$ loops/corners $	o$ digit shapes).\par
...
\smallskip
\textbf{4. Comprehensive Synthesis Table:}\par\smallskip
\smallskip
| Model Architecture | Optimizer | Learning Rate | Test Accuracy | Test Loss |\par
| :--- | :---: | :---: | :---: | :---: |\par
| Baseline (1 Hidden 512) | SGD | 0.01 | 92.58\% | 0.2871 |\par
| Baseline (1 Hidden 512) | SGD | 0.10 | 97.13\% | 0.1012 |\par
| Baseline (1 Hidden 512) | SGD | 0.20 | 97.35\% | 0.0894 |\par
| Baseline (1 Hidden 512) | Adagrad | 0.01 | 94.96\% | 0.1856 |\par
| Baseline (1 Hidden 512) | RMSprop | 0.001 | \textbf{98.30\%} | \textbf{0.0754} |\par
| Baseline (1 Hidden 512) | Adam | 0.001 | 98.00\% | 0.0812 |\par
| Deeper Regularized (512-256-128 + Dropout) | Adam | 0.001 | \textbf{98.14\%} | \textbf{0.0789} |\par
\smallskip
