...
\textbf{\normalsize\textbf{1. Learn About the Data}}\par\smallskip
\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{\normalsize\textbf{2. Build Neural Network Model}}\par\smallskip
\smallskip
...
\begin{quote}\textit{INPUT $\rightarrow$ LINEAR $\rightarrow$ RELU $\rightarrow$ LINEAR $\rightarrow$ SOFTMAX}\end{quote}
\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{\normalsize\textbf{3. Preprocessing}}\par\smallskip
\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{\normalsize\textbf{4. Model Training}}\par\smallskip
\smallskip
...
\smallskip
\textbf{\normalsize\textbf{Detailed Rational:}}\par\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{\normalsize\textbf{5. Model Evaluation}}\par\smallskip
\smallskip
...
\smallskip
\textbf{\normalsize\textbf{1. Frequently Misclassified Classes:}}\par\smallskip
...
\smallskip
\textbf{\normalsize\textbf{2. Precision and Recall of the Model:}}\par\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{\normalsize\textbf{6. Model tuning}}\par\smallskip
\smallskip
...
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
\textbf{\normalsize\textbf{7. Discussion and Result}}\par\smallskip
...
\smallskip
\textbf{\normalsize\textbf{1. Learning Rate ($\alpha$) Adjustment:}}\par\smallskip
...
\smallskip
\textbf{\normalsize\textbf{2. Optimizer Comparison:}}\par\smallskip
...
\smallskip
\textbf{\normalsize\textbf{3. Changing Model Structure (Depth \& Dropout):}}\par\smallskip
...
\smallskip
\textbf{\normalsize\textbf{4. Comprehensive Synthesis Table:}}\par\smallskip
\smallskip
\smallskip
\begin{center}
\small
